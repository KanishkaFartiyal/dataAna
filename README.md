...
├── pythondataAna/
│   └── projects/
│       └── 1.0-WinequalityEDA.ipynb   # Exploratory Data Analysis on wine quality dataset
...
2. Navigate to the project directory:
   ```bash
   cd dataAna/pythondataAna/projects
   ```
3. Launch Jupyter Notebook or open the file directly in VS Code:
   ```bash
